...
PICS = (environ.get('PICS', 'https://envs.sh/8qY.jpg https://envs.sh/8UJ.jpg')).split() #SAMPLE PIC
...
MSG_ALRT = environ.get('MSG_ALRT', '𝙲𝚑𝚎𝚌𝚔 𝚊𝚗𝚍 𝚝𝚛𝚢 𝚊𝚕𝚕 𝚖𝚢 𝚏𝚎𝚊𝚝𝚞𝚛𝚎𝚜')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002293013655'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/CINEMACCBOTDISCUSSION')
